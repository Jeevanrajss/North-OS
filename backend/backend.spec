...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "app.routers.data",
        "app.routers.app_logs",
        "app.routers.auth",
        "app.routers.debt",
        "app.routers.financial_goals",
        "app.routers.goals",
        "app.routers.health_tracking",
        "app.routers.investments",
        ...
        "app.services.ai_tag_suggester",
        "app.services.embeddings",
        "app.services.journal_summarizer",
        # App models
        "app.models.account",
        ...
        "app.models.contact",
        "app.models.debt",
        "app.models.debt_payment",
        "app.models.finance",
        "app.models.finance_category",
        "app.models.financial_goal",
        "app.models.goal",
        "app.models.habit",
        "app.models.health_log",
        "app.models.investment",
        "app.models.investment_entry",
        "app.models.journal",
        ...
        "app.models.user",
        # passlib picks its crypto backend dynamically from the "schemes"
        # string at runtime (CryptContext(schemes=["bcrypt"])), which
        # PyInstaller's static analysis can't trace — must be explicit.
        "passlib.handlers.bcrypt",
        "bcrypt",
        # python-jose JWT backends, same dynamic-lookup issue
